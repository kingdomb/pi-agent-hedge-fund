...
CORE_CHECKS = [
    ("Governance Audit", ".agent/scripts/governance_audit.py", True),
    ("Security Scan", ".agent/skills/vulnerability-scanner/scripts/security_scan.py", True),
    ("Lint Check", ".agent/skills/lint-and-validate/scripts/lint_runner.py", True),
    ("Schema Validation", ".agent/skills/database-design/scripts/schema_validator.py", False),
    ("Backend Tests", ".agent/skills/testing-patterns/scripts/test_runner.py", False),
    ("Frontend Tests", ".agent/skills/testing-patterns/scripts/test_runner.py", False), # Will run on frontend dir
    ("Brain Tests", ".agent/skills/testing-patterns/scripts/test_runner.py", True),     # New: Brain logic tests
...
def run_script(name: str, script_path: Path, project_path: str, url: Optional[str] = None) -> dict:
    ...
    # Special handling for Frontend/Backend tests
    if name == "Frontend Tests":
        target_path = str(Path(project_path) / "frontend")
    elif name == "Backend Tests":
        target_path = str(Path(project_path) / "backend")
    elif name == "Brain Tests":
        target_path = str(Path(project_path) / "ai-os-brain")

    cmd = [sys.executable, str(script_path), str(target_path)]
