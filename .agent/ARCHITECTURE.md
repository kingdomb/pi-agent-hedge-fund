...
| `project-sme` | Domain knowledge, feature inventory, drift detection | architecture |
| `docs-auditor` | Cross-document consistency, workflow doc enforcement | documentation-templates |
...
| `/audit-docs` | Documentation audit & drift detection |
